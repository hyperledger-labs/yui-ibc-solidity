...
func (_Ics20transferbank *Ics20transferbankTransactor) OnAcknowledgementPacket(opts *bind.TransactOpts, packet PacketData, acknowledgement []byte, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.contract.Transact(opts, "onAcknowledgementPacket", packet, acknowledgement, relayer)
}

// OnAcknowledgementPacket is a paid mutator transaction binding the contract method 0xfb8b532e.
//
// Solidity: function onAcknowledgementPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, bytes acknowledgement, address relayer) returns()
func (_Ics20transferbank *Ics20transferbankSession) OnAcknowledgementPacket(packet PacketData, acknowledgement []byte, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.OnAcknowledgementPacket(&_Ics20transferbank.TransactOpts, packet, acknowledgement, relayer)
}

// OnAcknowledgementPacket is a paid mutator transaction binding the contract method 0xfb8b532e.
//
// Solidity: function onAcknowledgementPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, bytes acknowledgement, address relayer) returns()
func (_Ics20transferbank *Ics20transferbankTransactorSession) OnAcknowledgementPacket(packet PacketData, acknowledgement []byte, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.OnAcknowledgementPacket(&_Ics20transferbank.TransactOpts, packet, acknowledgement, relayer)
}
...
func (_Ics20transferbank *Ics20transferbankTransactor) OnRecvPacket(opts *bind.TransactOpts, packet PacketData, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.contract.Transact(opts, "onRecvPacket", packet, relayer)
}

// OnRecvPacket is a paid mutator transaction binding the contract method 0x2301c6f5.
//
// Solidity: function onRecvPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, address relayer) returns(bytes acknowledgement)
func (_Ics20transferbank *Ics20transferbankSession) OnRecvPacket(packet PacketData, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.OnRecvPacket(&_Ics20transferbank.TransactOpts, packet, relayer)
}

// OnRecvPacket is a paid mutator transaction binding the contract method 0x2301c6f5.
//
// Solidity: function onRecvPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, address relayer) returns(bytes acknowledgement)
func (_Ics20transferbank *Ics20transferbankTransactorSession) OnRecvPacket(packet PacketData, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.OnRecvPacket(&_Ics20transferbank.TransactOpts, packet, relayer)
}
