...
func (_Ics20transferbank *Ics20transferbankTransactor) OnTimeoutPacket(opts *bind.TransactOpts, arg0 PacketData, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.contract.Transact(opts, "onTimeoutPacket", arg0, relayer)
}

// OnTimeoutPacket is a paid mutator transaction binding the contract method 0x52c7157d.
//
// Solidity: function onTimeoutPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) , address relayer) returns()
func (_Ics20transferbank *Ics20transferbankSession) OnTimeoutPacket(arg0 PacketData, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.OnTimeoutPacket(&_Ics20transferbank.TransactOpts, arg0, relayer)
}

// OnTimeoutPacket is a paid mutator transaction binding the contract method 0x52c7157d.
//
// Solidity: function onTimeoutPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) , address relayer) returns()
func (_Ics20transferbank *Ics20transferbankTransactorSession) OnTimeoutPacket(arg0 PacketData, relayer common.Address) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.OnTimeoutPacket(&_Ics20transferbank.TransactOpts, arg0, relayer)
}
