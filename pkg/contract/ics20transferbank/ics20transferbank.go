...
func (_Ics20transferbank *Ics20transferbankTransactor) SendTransfer(opts *bind.TransactOpts, denom string, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transferbank *Ics20transferbankSession) SendTransfer(denom string, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transferbank *Ics20transferbankTransactorSession) SendTransfer(denom string, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.SendTransfer(&_Ics20transferbank.TransactOpts, denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}
