...
func (_Ibchost *IbchostCaller) GetPacket(opts *bind.CallOpts, portId string, channelId string, sequence uint64) (PacketData, error) {
	var out []interface{}
	err := _Ibchost.contract.Call(opts, &out, "getPacket", portId, channelId, sequence)
...
//
// Solidity: function getPacket(string portId, string channelId, uint64 sequence) view returns((uint64,string,string,string,string,bytes,(uint64,uint64),uint64))
func (_Ibchost *IbchostSession) GetPacket(portId string, channelId string, sequence uint64) (PacketData, error) {
	return _Ibchost.Contract.GetPacket(&_Ibchost.CallOpts, portId, channelId, sequence)
}

// GetPacket is a free data retrieval call binding the contract method 0x162e3377.
//
// Solidity: function getPacket(string portId, string channelId, uint64 sequence) view returns((uint64,string,string,string,string,bytes,(uint64,uint64),uint64))
func (_Ibchost *IbchostCallerSession) GetPacket(portId string, channelId string, sequence uint64) (PacketData, error) {
	return _Ibchost.Contract.GetPacket(&_Ibchost.CallOpts, portId, channelId, sequence)
}
...
func (_Ibchost *IbchostTransactor) ClaimCapability(opts *bind.TransactOpts, name []byte) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "claimCapability", name)
}

// ClaimCapability is a paid mutator transaction binding the contract method 0x428a978b.
//
// Solidity: function claimCapability(bytes name) returns()
func (_Ibchost *IbchostSession) ClaimCapability(name []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.ClaimCapability(&_Ibchost.TransactOpts, name)
}

// ClaimCapability is a paid mutator transaction binding the contract method 0x428a978b.
//
// Solidity: function claimCapability(bytes name) returns()
func (_Ibchost *IbchostTransactorSession) ClaimCapability(name []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.ClaimCapability(&_Ibchost.TransactOpts, name)
}
...
func (_Ibchost *IbchostTransactor) NewCapability(opts *bind.TransactOpts, name []byte) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "newCapability", name)
}

// NewCapability is a paid mutator transaction binding the contract method 0x158e8e80.
//
// Solidity: function newCapability(bytes name) returns()
func (_Ibchost *IbchostSession) NewCapability(name []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.NewCapability(&_Ibchost.TransactOpts, name)
}

// NewCapability is a paid mutator transaction binding the contract method 0x158e8e80.
//
// Solidity: function newCapability(bytes name) returns()
func (_Ibchost *IbchostTransactorSession) NewCapability(name []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.NewCapability(&_Ibchost.TransactOpts, name)
}
