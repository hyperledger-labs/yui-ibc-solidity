...
// VerifyConnectionStateAndGet is a free data retrieval call binding the contract method 0x32f139b1.
//
// Solidity: function verifyConnectionStateAndGet((string,(string,string[])[],uint8,uint64,(string,string,(bytes))) connection, uint64 height, bytes proof, string connectionId, (string,(string,string[])[],uint8,uint64,(string,string,(bytes))) counterpartyConnection) view returns(bytes32, bytes32)
func (_Ibcconnection *IbcconnectionCaller) VerifyConnectionStateAndGet(opts *bind.CallOpts, connection ConnectionEndData, height uint64, proof []byte, connectionId string, counterpartyConnection ConnectionEndData) ([32]byte, [32]byte, error) {
	var out []interface{}
	err := _Ibcconnection.contract.Call(opts, &out, "verifyConnectionStateAndGet", connection, height, proof, connectionId, counterpartyConnection)
...
//
// Solidity: function verifyConnectionStateAndGet((string,(string,string[])[],uint8,uint64,(string,string,(bytes))) connection, uint64 height, bytes proof, string connectionId, (string,(string,string[])[],uint8,uint64,(string,string,(bytes))) counterpartyConnection) view returns(bytes32, bytes32)
func (_Ibcconnection *IbcconnectionSession) VerifyConnectionStateAndGet(connection ConnectionEndData, height uint64, proof []byte, connectionId string, counterpartyConnection ConnectionEndData) ([32]byte, [32]byte, error) {
	return _Ibcconnection.Contract.VerifyConnectionStateAndGet(&_Ibcconnection.CallOpts, connection, height, proof, connectionId, counterpartyConnection)
}

// VerifyConnectionStateAndGet is a free data retrieval call binding the contract method 0x32f139b1.
//
// Solidity: function verifyConnectionStateAndGet((string,(string,string[])[],uint8,uint64,(string,string,(bytes))) connection, uint64 height, bytes proof, string connectionId, (string,(string,string[])[],uint8,uint64,(string,string,(bytes))) counterpartyConnection) view returns(bytes32, bytes32)
func (_Ibcconnection *IbcconnectionCallerSession) VerifyConnectionStateAndGet(connection ConnectionEndData, height uint64, proof []byte, connectionId string, counterpartyConnection ConnectionEndData) ([32]byte, [32]byte, error) {
	return _Ibcconnection.Contract.VerifyConnectionStateAndGet(&_Ibcconnection.CallOpts, connection, height, proof, connectionId, counterpartyConnection)
}
