...
func (_Mockclient *MockclientTransactor) VerifyClientMessageAndUpdateState(opts *bind.TransactOpts, clientId string, clientMessageBytes []byte) (*types.Transaction, error) {
	return _Mockclient.contract.Transact(opts, "verifyClientMessageAndUpdateState", clientId, clientMessageBytes)
}

// VerifyClientMessageAndUpdateState is a paid mutator transaction binding the contract method 0xf9ec3614.
//
// Solidity: function verifyClientMessageAndUpdateState(string clientId, bytes clientMessageBytes) returns(bytes32 clientStateCommitment, (bytes32,(uint64,uint64))[] updates, bool ok)
func (_Mockclient *MockclientSession) VerifyClientMessageAndUpdateState(clientId string, clientMessageBytes []byte) (*types.Transaction, error) {
	return _Mockclient.Contract.VerifyClientMessageAndUpdateState(&_Mockclient.TransactOpts, clientId, clientMessageBytes)
}

// VerifyClientMessageAndUpdateState is a paid mutator transaction binding the contract method 0xf9ec3614.
//
// Solidity: function verifyClientMessageAndUpdateState(string clientId, bytes clientMessageBytes) returns(bytes32 clientStateCommitment, (bytes32,(uint64,uint64))[] updates, bool ok)
func (_Mockclient *MockclientTransactorSession) VerifyClientMessageAndUpdateState(clientId string, clientMessageBytes []byte) (*types.Transaction, error) {
	return _Mockclient.Contract.VerifyClientMessageAndUpdateState(&_Mockclient.TransactOpts, clientId, clientMessageBytes)
}
