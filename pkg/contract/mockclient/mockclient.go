...
func (_Mockclient *MockclientCaller) GetLatestInfo(opts *bind.CallOpts, clientId string) (struct {
	LatestHeight    HeightData
	LatestTimestamp uint64
	Status          uint8
}, error) {
	var out []interface{}
	err := _Mockclient.contract.Call(opts, &out, "getLatestInfo", clientId)
...
//
// Solidity: function getLatestInfo(string clientId) view returns((uint64,uint64) latestHeight, uint64 latestTimestamp, uint8 status)
func (_Mockclient *MockclientSession) GetLatestInfo(clientId string) (struct {
	LatestHeight    HeightData
	LatestTimestamp uint64
	Status          uint8
}, error) {
	return _Mockclient.Contract.GetLatestInfo(&_Mockclient.CallOpts, clientId)
}

// GetLatestInfo is a free data retrieval call binding the contract method 0xa5906897.
//
// Solidity: function getLatestInfo(string clientId) view returns((uint64,uint64) latestHeight, uint64 latestTimestamp, uint8 status)
func (_Mockclient *MockclientCallerSession) GetLatestInfo(clientId string) (struct {
	LatestHeight    HeightData
	LatestTimestamp uint64
	Status          uint8
}, error) {
