...
// DepositFrom is a paid mutator transaction binding the contract method 0x3f863481.
//
// Solidity: function depositFrom(address tokenContract, uint256 amount, address receiver) returns()
func (_Ics20bank *Ics20bankTransactor) DepositFrom(opts *bind.TransactOpts, tokenContract common.Address, amount *big.Int, receiver common.Address) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "depositFrom", tokenContract, amount, receiver)
}

// DepositFrom is a paid mutator transaction binding the contract method 0x3f863481.
//
// Solidity: function depositFrom(address tokenContract, uint256 amount, address receiver) returns()
func (_Ics20bank *Ics20bankSession) DepositFrom(tokenContract common.Address, amount *big.Int, receiver common.Address) (*types.Transaction, error) {
	return _Ics20bank.Contract.DepositFrom(&_Ics20bank.TransactOpts, tokenContract, amount, receiver)
}

// DepositFrom is a paid mutator transaction binding the contract method 0x3f863481.
//
// Solidity: function depositFrom(address tokenContract, uint256 amount, address receiver) returns()
func (_Ics20bank *Ics20bankTransactorSession) DepositFrom(tokenContract common.Address, amount *big.Int, receiver common.Address) (*types.Transaction, error) {
	return _Ics20bank.Contract.DepositFrom(&_Ics20bank.TransactOpts, tokenContract, amount, receiver)
}
