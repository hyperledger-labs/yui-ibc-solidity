...
func (_Ibcroutingmodule *IbcroutingmoduleTransactor) SendPacket(opts *bind.TransactOpts, packet PacketData) (*types.Transaction, error) {
	return _Ibcroutingmodule.contract.Transact(opts, "sendPacket", packet)
}

// SendPacket is a paid mutator transaction binding the contract method 0x40835e44.
//
// Solidity: function sendPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet) returns()
func (_Ibcroutingmodule *IbcroutingmoduleSession) SendPacket(packet PacketData) (*types.Transaction, error) {
	return _Ibcroutingmodule.Contract.SendPacket(&_Ibcroutingmodule.TransactOpts, packet)
}

// SendPacket is a paid mutator transaction binding the contract method 0x40835e44.
//
// Solidity: function sendPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet) returns()
func (_Ibcroutingmodule *IbcroutingmoduleTransactorSession) SendPacket(packet PacketData) (*types.Transaction, error) {
	return _Ibcroutingmodule.Contract.SendPacket(&_Ibcroutingmodule.TransactOpts, packet)
}
