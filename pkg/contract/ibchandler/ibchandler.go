...
func (_Ibchandler *IbchandlerCaller) GetCanTransitionToFlushComplete(opts *bind.CallOpts, portId string, channelId string) (bool, error) {
	var out []interface{}
	err := _Ibchandler.contract.Call(opts, &out, "getCanTransitionToFlushComplete", portId, channelId)
...
func (_Ibchandler *IbchandlerSession) GetCanTransitionToFlushComplete(portId string, channelId string) (bool, error) {
	return _Ibchandler.Contract.GetCanTransitionToFlushComplete(&_Ibchandler.CallOpts, portId, channelId)
}
...
func (_Ibchandler *IbchandlerCaller) GetCommitmentsSlot(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Ibchandler.contract.Call(opts, &out, "getCommitmentsSlot")
...
func (_Ibchandler *IbchandlerSession) GetCommitmentsSlot() ([32]byte, error) {
	return _Ibchandler.Contract.GetCommitmentsSlot(&_Ibchandler.CallOpts)
}
...
func (_Ibchandler *IbchandlerCaller) GetIBCModuleByChannel(opts *bind.CallOpts, portId string, channelId string) (common.Address, error) {
	var out []interface{}
	err := _Ibchandler.contract.Call(opts, &out, "getIBCModuleByChannel", portId, channelId)
...
func (_Ibchandler *IbchandlerSession) GetIBCModuleByChannel(portId string, channelId string) (common.Address, error) {
	return _Ibchandler.Contract.GetIBCModuleByChannel(&_Ibchandler.CallOpts, portId, channelId)
}
...
func (_Ibchandler *IbchandlerCaller) GetIBCModuleByPort(opts *bind.CallOpts, portId string) (common.Address, error) {
	var out []interface{}
	err := _Ibchandler.contract.Call(opts, &out, "getIBCModuleByPort", portId)
...
func (_Ibchandler *IbchandlerSession) GetIBCModuleByPort(portId string) (common.Address, error) {
	return _Ibchandler.Contract.GetIBCModuleByPort(&_Ibchandler.CallOpts, portId)
}
...
// GetRevisionNumber is a free data retrieval call binding the contract method 0x3fb7cb80.
//
// Solidity: function getRevisionNumber() view returns(uint64)
func (_Ibchandler *IbchandlerCaller) GetRevisionNumber(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _Ibchandler.contract.Call(opts, &out, "getRevisionNumber")
...
//
// Solidity: function getRevisionNumber() view returns(uint64)
func (_Ibchandler *IbchandlerSession) GetRevisionNumber() (uint64, error) {
	return _Ibchandler.Contract.GetRevisionNumber(&_Ibchandler.CallOpts)
}

// GetRevisionNumber is a free data retrieval call binding the contract method 0x3fb7cb80.
//
// Solidity: function getRevisionNumber() view returns(uint64)
func (_Ibchandler *IbchandlerCallerSession) GetRevisionNumber() (uint64, error) {
	return _Ibchandler.Contract.GetRevisionNumber(&_Ibchandler.CallOpts)
}
...
type IbchandlerIBCModuleManagerChannelCapabilityClaimedIterator struct {
	Event *IbchandlerIBCModuleManagerChannelCapabilityClaimed // Event containing the contract specifics and raw log
...
func (it *IbchandlerIBCModuleManagerChannelCapabilityClaimedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IbchandlerIBCModuleManagerChannelCapabilityClaimed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type IbchandlerIBCModuleManagerChannelCapabilityClaimed struct {
	PortId    string
	ChannelId string
...
func (_Ibchandler *IbchandlerFilterer) FilterIBCModuleManagerChannelCapabilityClaimed(opts *bind.FilterOpts) (*IbchandlerIBCModuleManagerChannelCapabilityClaimedIterator, error) {
	...
	logs, sub, err := _Ibchandler.contract.FilterLogs(opts, "IBCModuleManagerChannelCapabilityClaimed")
	if err != nil {
		return nil, err
	}
	return &IbchandlerIBCModuleManagerChannelCapabilityClaimedIterator{contract: _Ibchandler.contract, event: "IBCModuleManagerChannelCapabilityClaimed", logs: logs, sub: sub}, nil
}
...
func (_Ibchandler *IbchandlerFilterer) WatchIBCModuleManagerChannelCapabilityClaimed(opts *bind.WatchOpts, sink chan<- *IbchandlerIBCModuleManagerChannelCapabilityClaimed) (event.Subscription, error) {
	...
	logs, sub, err := _Ibchandler.contract.WatchLogs(opts, "IBCModuleManagerChannelCapabilityClaimed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IbchandlerIBCModuleManagerChannelCapabilityClaimed)
				if err := _Ibchandler.contract.UnpackLog(event, "IBCModuleManagerChannelCapabilityClaimed", log); err != nil {
					return err
				}
				event.Raw = log
...
type IbchandlerIBCModuleManagerPortCapabilityClaimedIterator struct {
	Event *IbchandlerIBCModuleManagerPortCapabilityClaimed // Event containing the contract specifics and raw log
...
func (it *IbchandlerIBCModuleManagerPortCapabilityClaimedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IbchandlerIBCModuleManagerPortCapabilityClaimed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type IbchandlerIBCModuleManagerPortCapabilityClaimed struct {
	PortId string
	Module common.Address
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_Ibchandler *IbchandlerFilterer) FilterIBCModuleManagerPortCapabilityClaimed(opts *bind.FilterOpts) (*IbchandlerIBCModuleManagerPortCapabilityClaimedIterator, error) {
	...
	logs, sub, err := _Ibchandler.contract.FilterLogs(opts, "IBCModuleManagerPortCapabilityClaimed")
	if err != nil {
		return nil, err
	}
	return &IbchandlerIBCModuleManagerPortCapabilityClaimedIterator{contract: _Ibchandler.contract, event: "IBCModuleManagerPortCapabilityClaimed", logs: logs, sub: sub}, nil
}
...
func (_Ibchandler *IbchandlerFilterer) WatchIBCModuleManagerPortCapabilityClaimed(opts *bind.WatchOpts, sink chan<- *IbchandlerIBCModuleManagerPortCapabilityClaimed) (event.Subscription, error) {
	...
	logs, sub, err := _Ibchandler.contract.WatchLogs(opts, "IBCModuleManagerPortCapabilityClaimed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IbchandlerIBCModuleManagerPortCapabilityClaimed)
				if err := _Ibchandler.contract.UnpackLog(event, "IBCModuleManagerPortCapabilityClaimed", log); err != nil {
					return err
				}
				event.Raw = log
