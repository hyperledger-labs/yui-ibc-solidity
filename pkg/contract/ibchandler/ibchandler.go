...
func (_Ibchandler *IbchandlerCaller) Channels(opts *bind.CallOpts, arg0 string, arg1 string) (struct {
	State        uint8
	Ordering     uint8
	Counterparty ChannelCounterpartyData
	Version      string
	...
	var out []interface{}
	err := _Ibchandler.contract.Call(opts, &out, "channels", arg0, arg1)
...
//
// Solidity: function channels(string , string ) view returns(uint8 state, uint8 ordering, (string,string) counterparty, string version)
func (_Ibchandler *IbchandlerSession) Channels(arg0 string, arg1 string) (struct {
	State        uint8
	Ordering     uint8
	Counterparty ChannelCounterpartyData
	Version      string
}, error) {
	return _Ibchandler.Contract.Channels(&_Ibchandler.CallOpts, arg0, arg1)
}

// Channels is a free data retrieval call binding the contract method 0x5b3de260.
//
// Solidity: function channels(string , string ) view returns(uint8 state, uint8 ordering, (string,string) counterparty, string version)
func (_Ibchandler *IbchandlerCallerSession) Channels(arg0 string, arg1 string) (struct {
	State        uint8
	Ordering     uint8
	Counterparty ChannelCounterpartyData
	Version      string
...
func (_Ibchandler *IbchandlerCaller) NextSequenceSends(opts *bind.CallOpts, arg0 string, arg1 string) (uint64, error) {
	var out []interface{}
	err := _Ibchandler.contract.Call(opts, &out, "nextSequenceSends", arg0, arg1)
...
//
// Solidity: function nextSequenceSends(string , string ) view returns(uint64)
func (_Ibchandler *IbchandlerSession) NextSequenceSends(arg0 string, arg1 string) (uint64, error) {
	return _Ibchandler.Contract.NextSequenceSends(&_Ibchandler.CallOpts, arg0, arg1)
}

// NextSequenceSends is a free data retrieval call binding the contract method 0x821cb5d0.
//
// Solidity: function nextSequenceSends(string , string ) view returns(uint64)
func (_Ibchandler *IbchandlerCallerSession) NextSequenceSends(arg0 string, arg1 string) (uint64, error) {
	return _Ibchandler.Contract.NextSequenceSends(&_Ibchandler.CallOpts, arg0, arg1)
}
