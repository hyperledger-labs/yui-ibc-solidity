...
func (_Ibft2client *Ibft2clientTransactor) UpdateClient(opts *bind.TransactOpts, clientId string, clientMessageBytes []byte) (*types.Transaction, error) {
	return _Ibft2client.contract.Transact(opts, "updateClient", clientId, clientMessageBytes)
}

// UpdateClient is a paid mutator transaction binding the contract method 0x6fbf8079.
//
// Solidity: function updateClient(string clientId, bytes clientMessageBytes) returns(bytes32 clientStateCommitment, (bytes32,(uint64,uint64))[] updates, bool ok)
func (_Ibft2client *Ibft2clientSession) UpdateClient(clientId string, clientMessageBytes []byte) (*types.Transaction, error) {
	return _Ibft2client.Contract.UpdateClient(&_Ibft2client.TransactOpts, clientId, clientMessageBytes)
}

// UpdateClient is a paid mutator transaction binding the contract method 0x6fbf8079.
//
// Solidity: function updateClient(string clientId, bytes clientMessageBytes) returns(bytes32 clientStateCommitment, (bytes32,(uint64,uint64))[] updates, bool ok)
func (_Ibft2client *Ibft2clientTransactorSession) UpdateClient(clientId string, clientMessageBytes []byte) (*types.Transaction, error) {
	return _Ibft2client.Contract.UpdateClient(&_Ibft2client.TransactOpts, clientId, clientMessageBytes)
}
