...
// GetPacketAcknowledgement is a free data retrieval call binding the contract method 0x06e42d6a.
//
// Solidity: function getPacketAcknowledgement(string portId, string channelId, uint64 sequence) view returns(bytes32, bool)
func (_Provablestore *ProvablestoreCaller) GetPacketAcknowledgement(opts *bind.CallOpts, portId string, channelId string, sequence uint64) ([32]byte, bool, error) {
	var out []interface{}
	err := _Provablestore.contract.Call(opts, &out, "getPacketAcknowledgement", portId, channelId, sequence)
...
//
// Solidity: function getPacketAcknowledgement(string portId, string channelId, uint64 sequence) view returns(bytes32, bool)
func (_Provablestore *ProvablestoreSession) GetPacketAcknowledgement(portId string, channelId string, sequence uint64) ([32]byte, bool, error) {
	return _Provablestore.Contract.GetPacketAcknowledgement(&_Provablestore.CallOpts, portId, channelId, sequence)
}

// GetPacketAcknowledgement is a free data retrieval call binding the contract method 0x06e42d6a.
//
// Solidity: function getPacketAcknowledgement(string portId, string channelId, uint64 sequence) view returns(bytes32, bool)
func (_Provablestore *ProvablestoreCallerSession) GetPacketAcknowledgement(portId string, channelId string, sequence uint64) ([32]byte, bool, error) {
	return _Provablestore.Contract.GetPacketAcknowledgement(&_Provablestore.CallOpts, portId, channelId, sequence)
}
...
func (_Provablestore *ProvablestoreCaller) HasPacketReceipt(opts *bind.CallOpts, portId string, channelId string, sequence uint64) (bool, error) {
	var out []interface{}
	err := _Provablestore.contract.Call(opts, &out, "hasPacketReceipt", portId, channelId, sequence)
...
//
// Solidity: function hasPacketReceipt(string portId, string channelId, uint64 sequence) view returns(bool)
func (_Provablestore *ProvablestoreSession) HasPacketReceipt(portId string, channelId string, sequence uint64) (bool, error) {
	return _Provablestore.Contract.HasPacketReceipt(&_Provablestore.CallOpts, portId, channelId, sequence)
}

// HasPacketReceipt is a free data retrieval call binding the contract method 0x5a9afac3.
//
// Solidity: function hasPacketReceipt(string portId, string channelId, uint64 sequence) view returns(bool)
func (_Provablestore *ProvablestoreCallerSession) HasPacketReceipt(portId string, channelId string, sequence uint64) (bool, error) {
	return _Provablestore.Contract.HasPacketReceipt(&_Provablestore.CallOpts, portId, channelId, sequence)
}
...
// PacketAcknowledgementKey is a free data retrieval call binding the contract method 0xa07a6ee2.
//
// Solidity: function packetAcknowledgementKey(string portId, string channelId, uint64 sequence) pure returns(bytes32)
func (_Provablestore *ProvablestoreCaller) PacketAcknowledgementKey(opts *bind.CallOpts, portId string, channelId string, sequence uint64) ([32]byte, error) {
	var out []interface{}
	err := _Provablestore.contract.Call(opts, &out, "packetAcknowledgementKey", portId, channelId, sequence)
...
//
// Solidity: function packetAcknowledgementKey(string portId, string channelId, uint64 sequence) pure returns(bytes32)
func (_Provablestore *ProvablestoreSession) PacketAcknowledgementKey(portId string, channelId string, sequence uint64) ([32]byte, error) {
	return _Provablestore.Contract.PacketAcknowledgementKey(&_Provablestore.CallOpts, portId, channelId, sequence)
}

// PacketAcknowledgementKey is a free data retrieval call binding the contract method 0xa07a6ee2.
//
// Solidity: function packetAcknowledgementKey(string portId, string channelId, uint64 sequence) pure returns(bytes32)
func (_Provablestore *ProvablestoreCallerSession) PacketAcknowledgementKey(portId string, channelId string, sequence uint64) ([32]byte, error) {
	return _Provablestore.Contract.PacketAcknowledgementKey(&_Provablestore.CallOpts, portId, channelId, sequence)
}

// PacketAcknowledgementSlot is a free data retrieval call binding the contract method 0xf49cb5a7.
//
// Solidity: function packetAcknowledgementSlot(string portId, string channelId, uint64 sequence) pure returns(bytes32)
func (_Provablestore *ProvablestoreCaller) PacketAcknowledgementSlot(opts *bind.CallOpts, portId string, channelId string, sequence uint64) ([32]byte, error) {
	var out []interface{}
	err := _Provablestore.contract.Call(opts, &out, "packetAcknowledgementSlot", portId, channelId, sequence)
...
//
// Solidity: function packetAcknowledgementSlot(string portId, string channelId, uint64 sequence) pure returns(bytes32)
func (_Provablestore *ProvablestoreSession) PacketAcknowledgementSlot(portId string, channelId string, sequence uint64) ([32]byte, error) {
	return _Provablestore.Contract.PacketAcknowledgementSlot(&_Provablestore.CallOpts, portId, channelId, sequence)
}

// PacketAcknowledgementSlot is a free data retrieval call binding the contract method 0xf49cb5a7.
//
// Solidity: function packetAcknowledgementSlot(string portId, string channelId, uint64 sequence) pure returns(bytes32)
func (_Provablestore *ProvablestoreCallerSession) PacketAcknowledgementSlot(portId string, channelId string, sequence uint64) ([32]byte, error) {
	return _Provablestore.Contract.PacketAcknowledgementSlot(&_Provablestore.CallOpts, portId, channelId, sequence)
}
...
// SetPacketAcknowledgement is a paid mutator transaction binding the contract method 0x9804b02e.
//
// Solidity: function setPacketAcknowledgement(string portId, string channelId, uint64 sequence, bytes acknowledgement) returns()
func (_Provablestore *ProvablestoreTransactor) SetPacketAcknowledgement(opts *bind.TransactOpts, portId string, channelId string, sequence uint64, acknowledgement []byte) (*types.Transaction, error) {
	return _Provablestore.contract.Transact(opts, "setPacketAcknowledgement", portId, channelId, sequence, acknowledgement)
}

// SetPacketAcknowledgement is a paid mutator transaction binding the contract method 0x9804b02e.
//
// Solidity: function setPacketAcknowledgement(string portId, string channelId, uint64 sequence, bytes acknowledgement) returns()
func (_Provablestore *ProvablestoreSession) SetPacketAcknowledgement(portId string, channelId string, sequence uint64, acknowledgement []byte) (*types.Transaction, error) {
	return _Provablestore.Contract.SetPacketAcknowledgement(&_Provablestore.TransactOpts, portId, channelId, sequence, acknowledgement)
}

// SetPacketAcknowledgement is a paid mutator transaction binding the contract method 0x9804b02e.
//
// Solidity: function setPacketAcknowledgement(string portId, string channelId, uint64 sequence, bytes acknowledgement) returns()
func (_Provablestore *ProvablestoreTransactorSession) SetPacketAcknowledgement(portId string, channelId string, sequence uint64, acknowledgement []byte) (*types.Transaction, error) {
	return _Provablestore.Contract.SetPacketAcknowledgement(&_Provablestore.TransactOpts, portId, channelId, sequence, acknowledgement)
}
...
func (_Provablestore *ProvablestoreTransactor) SetPacketReceipt(opts *bind.TransactOpts, portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Provablestore.contract.Transact(opts, "setPacketReceipt", portId, channelId, sequence)
}

// SetPacketReceipt is a paid mutator transaction binding the contract method 0xf2a47da3.
//
// Solidity: function setPacketReceipt(string portId, string channelId, uint64 sequence) returns()
func (_Provablestore *ProvablestoreSession) SetPacketReceipt(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Provablestore.Contract.SetPacketReceipt(&_Provablestore.TransactOpts, portId, channelId, sequence)
}

// SetPacketReceipt is a paid mutator transaction binding the contract method 0xf2a47da3.
//
// Solidity: function setPacketReceipt(string portId, string channelId, uint64 sequence) returns()
func (_Provablestore *ProvablestoreTransactorSession) SetPacketReceipt(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Provablestore.Contract.SetPacketReceipt(&_Provablestore.TransactOpts, portId, channelId, sequence)
}
