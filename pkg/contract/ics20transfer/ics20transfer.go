...
// CheckPrefix is a free data retrieval call binding the contract method 0x06ec9c9c.
//
// Solidity: function checkPrefix(string denom, string sourcePort, string sourceChannel) view returns(bool)
func (_Ics20transfer *Ics20transferCaller) CheckPrefix(opts *bind.CallOpts, denom string, sourcePort string, sourceChannel string) (bool, error) {
	var out []interface{}
	err := _Ics20transfer.contract.Call(opts, &out, "checkPrefix", denom, sourcePort, sourceChannel)
...
//
// Solidity: function checkPrefix(string denom, string sourcePort, string sourceChannel) view returns(bool)
func (_Ics20transfer *Ics20transferSession) CheckPrefix(denom string, sourcePort string, sourceChannel string) (bool, error) {
	return _Ics20transfer.Contract.CheckPrefix(&_Ics20transfer.CallOpts, denom, sourcePort, sourceChannel)
}

// CheckPrefix is a free data retrieval call binding the contract method 0x06ec9c9c.
//
// Solidity: function checkPrefix(string denom, string sourcePort, string sourceChannel) view returns(bool)
func (_Ics20transfer *Ics20transferCallerSession) CheckPrefix(denom string, sourcePort string, sourceChannel string) (bool, error) {
	return _Ics20transfer.Contract.CheckPrefix(&_Ics20transfer.CallOpts, denom, sourcePort, sourceChannel)
}
