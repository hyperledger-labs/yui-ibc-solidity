...
func (_Ics20transfer *Ics20transferTransactor) SendTransfer(opts *bind.TransactOpts, denom string, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferSession) SendTransfer(denom string, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactorSession) SendTransfer(denom string, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.SendTransfer(&_Ics20transfer.TransactOpts, denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}
