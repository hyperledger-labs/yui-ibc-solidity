...
// DepositSendTransfer is a paid mutator transaction binding the contract method 0x4ac6f13b.
//
// Solidity: function depositSendTransfer(address tokenContract, uint256 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns(uint64)
func (_Ics20transfer *Ics20transferTransactor) DepositSendTransfer(opts *bind.TransactOpts, tokenContract common.Address, amount *big.Int, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.contract.Transact(opts, "depositSendTransfer", tokenContract, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// DepositSendTransfer is a paid mutator transaction binding the contract method 0x4ac6f13b.
//
// Solidity: function depositSendTransfer(address tokenContract, uint256 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns(uint64)
func (_Ics20transfer *Ics20transferSession) DepositSendTransfer(tokenContract common.Address, amount *big.Int, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.DepositSendTransfer(&_Ics20transfer.TransactOpts, tokenContract, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// DepositSendTransfer is a paid mutator transaction binding the contract method 0x4ac6f13b.
//
// Solidity: function depositSendTransfer(address tokenContract, uint256 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns(uint64)
func (_Ics20transfer *Ics20transferTransactorSession) DepositSendTransfer(tokenContract common.Address, amount *big.Int, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.DepositSendTransfer(&_Ics20transfer.TransactOpts, tokenContract, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}
...
//
// Solidity: function sendTransfer(string denom, uint256 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns(uint64)
func (_Ics20transfer *Ics20transferTransactor) SendTransfer(opts *bind.TransactOpts, denom string, amount *big.Int, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint256 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns(uint64)
func (_Ics20transfer *Ics20transferSession) SendTransfer(denom string, amount *big.Int, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint256 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns(uint64)
func (_Ics20transfer *Ics20transferTransactorSession) SendTransfer(denom string, amount *big.Int, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.SendTransfer(&_Ics20transfer.TransactOpts, denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}
