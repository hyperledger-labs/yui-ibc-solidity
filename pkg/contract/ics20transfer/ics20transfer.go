...
// TransferToken is a paid mutator transaction binding the contract method 0x74b40e6b.
//
// Solidity: function transferToken(address tokenContract, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactor) TransferToken(opts *bind.TransactOpts, tokenContract common.Address, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.contract.Transact(opts, "transferToken", tokenContract, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// TransferToken is a paid mutator transaction binding the contract method 0x74b40e6b.
//
// Solidity: function transferToken(address tokenContract, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferSession) TransferToken(tokenContract common.Address, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.TransferToken(&_Ics20transfer.TransactOpts, tokenContract, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// TransferToken is a paid mutator transaction binding the contract method 0x74b40e6b.
//
// Solidity: function transferToken(address tokenContract, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactorSession) TransferToken(tokenContract common.Address, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.TransferToken(&_Ics20transfer.TransactOpts, tokenContract, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// TransferVoucher is a paid mutator transaction binding the contract method 0xf2cb863f.
//
// Solidity: function transferVoucher(string denom, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactor) TransferVoucher(opts *bind.TransactOpts, denom string, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.contract.Transact(opts, "transferVoucher", denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// TransferVoucher is a paid mutator transaction binding the contract method 0xf2cb863f.
//
// Solidity: function transferVoucher(string denom, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferSession) TransferVoucher(denom string, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.TransferVoucher(&_Ics20transfer.TransactOpts, denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// TransferVoucher is a paid mutator transaction binding the contract method 0xf2cb863f.
//
// Solidity: function transferVoucher(string denom, uint64 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactorSession) TransferVoucher(denom string, amount uint64, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.TransferVoucher(&_Ics20transfer.TransactOpts, denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}
