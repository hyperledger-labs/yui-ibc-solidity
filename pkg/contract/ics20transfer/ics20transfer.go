...
// TransferToken is a paid mutator transaction binding the contract method 0x87351113.
//
// Solidity: function transferToken(address tokenContract, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactor) TransferToken(opts *bind.TransactOpts, tokenContract common.Address, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function transferToken(address tokenContract, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferSession) TransferToken(tokenContract common.Address, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function transferToken(address tokenContract, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactorSession) TransferToken(tokenContract common.Address, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.TransferToken(&_Ics20transfer.TransactOpts, tokenContract, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}

// TransferVoucher is a paid mutator transaction binding the contract method 0xed14f906.
//
// Solidity: function transferVoucher(string denom, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactor) TransferVoucher(opts *bind.TransactOpts, denom string, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function transferVoucher(string denom, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferSession) TransferVoucher(denom string, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function transferVoucher(string denom, uint256 amount, address receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transfer *Ics20transferTransactorSession) TransferVoucher(denom string, amount *big.Int, receiver common.Address, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transfer.Contract.TransferVoucher(&_Ics20transfer.TransactOpts, denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}
