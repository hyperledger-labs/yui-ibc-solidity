...
func (_Ibcstore *IbcstoreCaller) AuthenticateCapability(opts *bind.CallOpts, name []byte, addr common.Address) (bool, error) {
	var out []interface{}
	err := _Ibcstore.contract.Call(opts, &out, "authenticateCapability", name, addr)
...
//
// Solidity: function authenticateCapability(bytes name, address addr) view returns(bool)
func (_Ibcstore *IbcstoreSession) AuthenticateCapability(name []byte, addr common.Address) (bool, error) {
	return _Ibcstore.Contract.AuthenticateCapability(&_Ibcstore.CallOpts, name, addr)
}

// AuthenticateCapability is a free data retrieval call binding the contract method 0x2d46858f.
//
// Solidity: function authenticateCapability(bytes name, address addr) view returns(bool)
func (_Ibcstore *IbcstoreCallerSession) AuthenticateCapability(name []byte, addr common.Address) (bool, error) {
	return _Ibcstore.Contract.AuthenticateCapability(&_Ibcstore.CallOpts, name, addr)
}
...
func (_Ibcstore *IbcstoreCaller) GetClientState(opts *bind.CallOpts, clientId string) ([]byte, bool, error) {
	var out []interface{}
...
//
// Solidity: function getClientState(string clientId) view returns(bytes, bool)
func (_Ibcstore *IbcstoreSession) GetClientState(clientId string) ([]byte, bool, error) {
...
//
// Solidity: function getClientState(string clientId) view returns(bytes, bool)
func (_Ibcstore *IbcstoreCallerSession) GetClientState(clientId string) ([]byte, bool, error) {
	return _Ibcstore.Contract.GetClientState(&_Ibcstore.CallOpts, clientId)
}
...
func (_Ibcstore *IbcstoreCaller) GetConsensusState(opts *bind.CallOpts, clientId string, height uint64) ([]byte, bool, error) {
	var out []interface{}
...
//
// Solidity: function getConsensusState(string clientId, uint64 height) view returns(bytes, bool)
func (_Ibcstore *IbcstoreSession) GetConsensusState(clientId string, height uint64) ([]byte, bool, error) {
...
//
// Solidity: function getConsensusState(string clientId, uint64 height) view returns(bytes, bool)
func (_Ibcstore *IbcstoreCallerSession) GetConsensusState(clientId string, height uint64) ([]byte, bool, error) {
	return _Ibcstore.Contract.GetConsensusState(&_Ibcstore.CallOpts, clientId, height)
}
...
func (_Ibcstore *IbcstoreCaller) GetPacketCommitment(opts *bind.CallOpts, portId string, channelId string, sequence uint64) ([32]byte, bool, error) {
	var out []interface{}
	err := _Ibcstore.contract.Call(opts, &out, "getPacketCommitment", portId, channelId, sequence)
...
//
// Solidity: function getPacketCommitment(string portId, string channelId, uint64 sequence) view returns(bytes32, bool)
func (_Ibcstore *IbcstoreSession) GetPacketCommitment(portId string, channelId string, sequence uint64) ([32]byte, bool, error) {
	return _Ibcstore.Contract.GetPacketCommitment(&_Ibcstore.CallOpts, portId, channelId, sequence)
}

// GetPacketCommitment is a free data retrieval call binding the contract method 0x61fc5e7b.
//
// Solidity: function getPacketCommitment(string portId, string channelId, uint64 sequence) view returns(bytes32, bool)
func (_Ibcstore *IbcstoreCallerSession) GetPacketCommitment(portId string, channelId string, sequence uint64) ([32]byte, bool, error) {
	return _Ibcstore.Contract.GetPacketCommitment(&_Ibcstore.CallOpts, portId, channelId, sequence)
}
...
// ClaimCapability is a paid mutator transaction binding the contract method 0x428a978b.
//
// Solidity: function claimCapability(bytes name) returns()
func (_Ibcstore *IbcstoreTransactor) ClaimCapability(opts *bind.TransactOpts, name []byte) (*types.Transaction, error) {
	return _Ibcstore.contract.Transact(opts, "claimCapability", name)
}

// ClaimCapability is a paid mutator transaction binding the contract method 0x428a978b.
//
// Solidity: function claimCapability(bytes name) returns()
func (_Ibcstore *IbcstoreSession) ClaimCapability(name []byte) (*types.Transaction, error) {
	return _Ibcstore.Contract.ClaimCapability(&_Ibcstore.TransactOpts, name)
}

// ClaimCapability is a paid mutator transaction binding the contract method 0x428a978b.
//
// Solidity: function claimCapability(bytes name) returns()
func (_Ibcstore *IbcstoreTransactorSession) ClaimCapability(name []byte) (*types.Transaction, error) {
	return _Ibcstore.Contract.ClaimCapability(&_Ibcstore.TransactOpts, name)
}
...
// NewCapability is a paid mutator transaction binding the contract method 0x158e8e80.
//
// Solidity: function newCapability(bytes name) returns()
func (_Ibcstore *IbcstoreTransactor) NewCapability(opts *bind.TransactOpts, name []byte) (*types.Transaction, error) {
	return _Ibcstore.contract.Transact(opts, "newCapability", name)
}

// NewCapability is a paid mutator transaction binding the contract method 0x158e8e80.
//
// Solidity: function newCapability(bytes name) returns()
func (_Ibcstore *IbcstoreSession) NewCapability(name []byte) (*types.Transaction, error) {
	return _Ibcstore.Contract.NewCapability(&_Ibcstore.TransactOpts, name)
}

// NewCapability is a paid mutator transaction binding the contract method 0x158e8e80.
//
// Solidity: function newCapability(bytes name) returns()
func (_Ibcstore *IbcstoreTransactorSession) NewCapability(name []byte) (*types.Transaction, error) {
	return _Ibcstore.Contract.NewCapability(&_Ibcstore.TransactOpts, name)
}
