...
//
// Solidity: function acknowledgePacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, bytes acknowledgement, bytes proof, uint64 proofHeight) returns()
func (_Ibcchannel *IbcchannelTransactor) AcknowledgePacket(opts *bind.TransactOpts, packet PacketData, acknowledgement []byte, proof []byte, proofHeight uint64) (*types.Transaction, error) {
	return _Ibcchannel.contract.Transact(opts, "acknowledgePacket", packet, acknowledgement, proof, proofHeight)
}

// AcknowledgePacket is a paid mutator transaction binding the contract method 0xbeb4e3d0.
//
// Solidity: function acknowledgePacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, bytes acknowledgement, bytes proof, uint64 proofHeight) returns()
func (_Ibcchannel *IbcchannelSession) AcknowledgePacket(packet PacketData, acknowledgement []byte, proof []byte, proofHeight uint64) (*types.Transaction, error) {
	return _Ibcchannel.Contract.AcknowledgePacket(&_Ibcchannel.TransactOpts, packet, acknowledgement, proof, proofHeight)
}

// AcknowledgePacket is a paid mutator transaction binding the contract method 0xbeb4e3d0.
//
// Solidity: function acknowledgePacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, bytes acknowledgement, bytes proof, uint64 proofHeight) returns()
func (_Ibcchannel *IbcchannelTransactorSession) AcknowledgePacket(packet PacketData, acknowledgement []byte, proof []byte, proofHeight uint64) (*types.Transaction, error) {
	return _Ibcchannel.Contract.AcknowledgePacket(&_Ibcchannel.TransactOpts, packet, acknowledgement, proof, proofHeight)
}
