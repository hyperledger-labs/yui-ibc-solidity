...
// AcknowledgePacket is a paid mutator transaction binding the contract method 0xbeb4e3d0.
//
// Solidity: function acknowledgePacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) , bytes acknowledgement, bytes proof, uint64 proofHeight) returns()
func (_Ibcchannel *IbcchannelTransactor) AcknowledgePacket(opts *bind.TransactOpts, arg0 PacketData, acknowledgement []byte, proof []byte, proofHeight uint64) (*types.Transaction, error) {
	return _Ibcchannel.contract.Transact(opts, "acknowledgePacket", arg0, acknowledgement, proof, proofHeight)
}

// AcknowledgePacket is a paid mutator transaction binding the contract method 0xbeb4e3d0.
//
// Solidity: function acknowledgePacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) , bytes acknowledgement, bytes proof, uint64 proofHeight) returns()
func (_Ibcchannel *IbcchannelSession) AcknowledgePacket(arg0 PacketData, acknowledgement []byte, proof []byte, proofHeight uint64) (*types.Transaction, error) {
	return _Ibcchannel.Contract.AcknowledgePacket(&_Ibcchannel.TransactOpts, arg0, acknowledgement, proof, proofHeight)
}

// AcknowledgePacket is a paid mutator transaction binding the contract method 0xbeb4e3d0.
//
// Solidity: function acknowledgePacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) , bytes acknowledgement, bytes proof, uint64 proofHeight) returns()
func (_Ibcchannel *IbcchannelTransactorSession) AcknowledgePacket(arg0 PacketData, acknowledgement []byte, proof []byte, proofHeight uint64) (*types.Transaction, error) {
	return _Ibcchannel.Contract.AcknowledgePacket(&_Ibcchannel.TransactOpts, arg0, acknowledgement, proof, proofHeight)
}
