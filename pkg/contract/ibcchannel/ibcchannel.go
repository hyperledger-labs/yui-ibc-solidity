...
func (_Ibcchannel *IbcchannelCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Ibcchannel.contract.Call(opts, &out, "owner")
...
//
// Solidity: function owner() view returns(address)
func (_Ibcchannel *IbcchannelSession) Owner() (common.Address, error) {
	return _Ibcchannel.Contract.Owner(&_Ibcchannel.CallOpts)
}

// Owner is a free data retrieval call binding the contract method 0x8da5cb5b.
//
// Solidity: function owner() view returns(address)
func (_Ibcchannel *IbcchannelCallerSession) Owner() (common.Address, error) {
	return _Ibcchannel.Contract.Owner(&_Ibcchannel.CallOpts)
}
...
//
// Solidity: function setIBCModule(address ibcModuleAddress_) returns()
func (_Ibcchannel *IbcchannelTransactor) SetIBCModule(opts *bind.TransactOpts, ibcModuleAddress_ common.Address) (*types.Transaction, error) {
	return _Ibcchannel.contract.Transact(opts, "setIBCModule", ibcModuleAddress_)
}

// SetIBCModule is a paid mutator transaction binding the contract method 0x1e742f32.
//
// Solidity: function setIBCModule(address ibcModuleAddress_) returns()
func (_Ibcchannel *IbcchannelSession) SetIBCModule(ibcModuleAddress_ common.Address) (*types.Transaction, error) {
	return _Ibcchannel.Contract.SetIBCModule(&_Ibcchannel.TransactOpts, ibcModuleAddress_)
}

// SetIBCModule is a paid mutator transaction binding the contract method 0x1e742f32.
//
// Solidity: function setIBCModule(address ibcModuleAddress_) returns()
func (_Ibcchannel *IbcchannelTransactorSession) SetIBCModule(ibcModuleAddress_ common.Address) (*types.Transaction, error) {
	return _Ibcchannel.Contract.SetIBCModule(&_Ibcchannel.TransactOpts, ibcModuleAddress_)
}
...
func (_Ibcchannel *IbcchannelTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _Ibcchannel.contract.Transact(opts, "transferOwnership", newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Ibcchannel *IbcchannelSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Ibcchannel.Contract.TransferOwnership(&_Ibcchannel.TransactOpts, newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Ibcchannel *IbcchannelTransactorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Ibcchannel.Contract.TransferOwnership(&_Ibcchannel.TransactOpts, newOwner)
}
