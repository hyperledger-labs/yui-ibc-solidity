...
// SendPacket2 is a paid mutator transaction binding the contract method 0x8946b30d.
//
// Solidity: function sendPacket2((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet) returns()
func (_Ibcchannel *IbcchannelTransactor) SendPacket2(opts *bind.TransactOpts, packet PacketData) (*types.Transaction, error) {
	return _Ibcchannel.contract.Transact(opts, "sendPacket2", packet)
}

// SendPacket2 is a paid mutator transaction binding the contract method 0x8946b30d.
//
// Solidity: function sendPacket2((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet) returns()
func (_Ibcchannel *IbcchannelSession) SendPacket2(packet PacketData) (*types.Transaction, error) {
	return _Ibcchannel.Contract.SendPacket2(&_Ibcchannel.TransactOpts, packet)
}

// SendPacket2 is a paid mutator transaction binding the contract method 0x8946b30d.
//
// Solidity: function sendPacket2((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet) returns()
func (_Ibcchannel *IbcchannelTransactorSession) SendPacket2(packet PacketData) (*types.Transaction, error) {
	return _Ibcchannel.Contract.SendPacket2(&_Ibcchannel.TransactOpts, packet)
}
