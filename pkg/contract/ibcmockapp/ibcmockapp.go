...
func (_Ibcmockapp *IbcmockappCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Ibcmockapp.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() view returns(string)
func (_Ibcmockapp *IbcmockappSession) Version() (string, error) {
	return _Ibcmockapp.Contract.Version(&_Ibcmockapp.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() view returns(string)
func (_Ibcmockapp *IbcmockappCallerSession) Version() (string, error) {
	return _Ibcmockapp.Contract.Version(&_Ibcmockapp.CallOpts)
}
