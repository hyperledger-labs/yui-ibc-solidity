...
func (_Ibcmockapp *IbcmockappCaller) OnTimeoutPacket(opts *bind.CallOpts, packet PacketData, arg1 common.Address) error {
	var out []interface{}
...
//
// Solidity: function onTimeoutPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, address ) view returns()
func (_Ibcmockapp *IbcmockappSession) OnTimeoutPacket(packet PacketData, arg1 common.Address) error {
...
//
// Solidity: function onTimeoutPacket((uint64,string,string,string,string,bytes,(uint64,uint64),uint64) packet, address ) view returns()
func (_Ibcmockapp *IbcmockappCallerSession) OnTimeoutPacket(packet PacketData, arg1 common.Address) error {
	return _Ibcmockapp.Contract.OnTimeoutPacket(&_Ibcmockapp.CallOpts, packet, arg1)
}
